...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-4 pt-20 pb-16 overflow-hidden py-0 bg-lime-500">
      ...
      <div className="absolute bottom-6 left-6 z-10">
        <Button onClick={handleWhatsAppClick} className="bg-honey-500 hover:bg-honey-600 text-white p-6 rounded-full text-lg shadow-lg transition-all hover:shadow-xl hover:-translate-y-1">
